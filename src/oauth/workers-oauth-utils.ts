...
// Adapted from Cloudflare's official template
...
/**
 * Creates and stores OAuth state information
 */
...
<body>
  <div class="container">
    <div class="card">
      ...
      <p class="permissions">
        This will allow <strong>${clientName}</strong> to access 30 utility tools including date/time, math, text processing, validation, KV storage, and Workers AI capabilities.
      </p>
